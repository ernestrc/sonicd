...
function exec(address, query, done, outputCb, progressCb, metadataCb) {
...
Client.prototype.stream = function(query, traceId) {
  ...
  exec(this.address, queryMsg, done, output, progress, metadata);

  return emitter;
};

Client.prototype.run = function(query, doneCb, traceId) {
  ...
  exec(this.address, queryMsg, done, output);
};
...
Client.prototype.authenticate = function(user, apiKey, doneCb, traceId) {
  ...
  exec(this.address, authMsg, done, output);
};
